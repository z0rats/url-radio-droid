 ...
 * list (here: [com.urlradiodroid.ui.MainScreen]'s station list). Long-press starts the drag;
 ...
 * list, e.g. [com.urlradiodroid.ui.MainViewModel.moveStation]); releasing calls [onDragEnd].
 *
