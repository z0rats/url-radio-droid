 ...
 * [com.freqcast.ui.AlarmReceiver] and [com.freqcast.ui.BootReceiver] can read it and
...
class AlarmStateStore(
    ...
    /** Wipes the stored alarm — called once [restore]'s data has been imported into Room, see [com.freqcast.data.AlarmRepository.migrateLegacyAlarmIfNeeded]. */
    fun clear() {
